...
#Bot token @Botfather
TG_BOT_TOKEN = os.environ.get("TG_BOT_TOKEN", "7193814472:AAEj5yXdhFIlBJsybP0AXniKxRghVHMCU-I")
...
FORCESUB_CHANNEL2 = int(os.environ.get("FORCESUB_CHANNEL2", "-1001919427266"))
